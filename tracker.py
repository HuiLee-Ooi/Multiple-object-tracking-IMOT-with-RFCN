...
class Tracker(object):
    ...
    def Update(self, detections, feat_per_frame, feat_index, frame_num):
        ...
        for i in range(len(self.tracks)):
            for j in range(len(detections)):
                try:
                    # cost[i][j] = cv2.compareHist(feat_per_frame[frame_num][feat_index][i],
                    #                              feat_per_frame[frame_num - 1][feat_index][j], 4)

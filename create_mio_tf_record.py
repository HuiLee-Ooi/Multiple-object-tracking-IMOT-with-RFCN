...
flags.DEFINE_string('label_map_path', 'data/mio_label_map.pbtxt',
...
def main(_):
  ...
  if FLAGS.set == "validation":
      annotations_dir = os.path.join(data_dir, "val_annotations")
  if FLAGS.set == "test":
      annotations_dir = os.path.join(data_dir, "test_annotations")
